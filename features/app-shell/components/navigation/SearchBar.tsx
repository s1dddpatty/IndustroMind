...
export const SearchBar = memo(function SearchBar() {
  ...
  return (
    <div className="relative flex items-center flex-1 w-full min-w-[380px] max-w-[480px]">
      ...
      <input
        type="text"
        aria-label="Search"
        className={`w-full h-11 ${navTokens.searchBg} ${navTokens.searchBorder} ${navTokens.text} text-sm rounded-full pl-11 pr-12 focus:outline-none focus:ring-1 ${navTokens.searchFocus} transition-colors duration-200 ${navTokens.searchPlaceholder}`}
